...
void solve()
{
    ...
    ffor(i,0,n){
        ...
        // delete
        while(rud>k){
            if(s[last]=='a'){rud-=numB;numA--;}
            else if(s[last]=='b'){numB--;}
            last++;
        }
        // sync ans
...
// on insertion of 'b' rudness increases by (number of a's present in the substring)
// on insertion of 'a' rudness doesnt increase
// on deletion of 'b' rudness doesnt decrease
// on deletion of 'a' rudness decreases by (number of b's present in the substring)
// insertion/deletion of any other charcter doesnt affect the rudness
/*-------------------------------------end-------------------------------------*/
signed main()
{
    mahadev;
